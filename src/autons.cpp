...
void rightSixLong() {
    ...
    chassis.moveToPoint(43, 63.25, 2000, {.minSpeed = 15, .earlyExitRange = 2, .pidSelector = 1});
    pros::delay(100);
    matchload.matchloadV(0);
    chassis.swingToHeading(90, DriveSide::RIGHT, 800, {.direction = AngularDirection::CW_CLOCKWISE, .minSpeed = 25, .earlyExitRange = 10});
    chassis.swingToPoint(41, 53, DriveSide::RIGHT, 1500, {.forwards = false, .direction = AngularDirection::CCW_COUNTERCLOCKWISE, .minSpeed = 25, .earlyExitRange = 2});
    chassis.moveToPoint(41, 53, 1900, {.forwards = false, .minSpeed = 25, .earlyExitRange = 2, .clampDistance = false});
    chassis.swingToHeading(180, DriveSide::RIGHT, 2000, {.direction = AngularDirection::CCW_COUNTERCLOCKWISE, .minSpeed = 75, .earlyExitRange = 5});
    //chassis.waitUntil(11);
    chassis.waitUntilDone();
...
void soloWinPoint() {
    ...
    chassis.resetPositionFront();
    intake.stopIntake();
    chassis.turnToPoint(23.5, 47.75, 1100, {.minSpeed = 40, .earlyExitRange = 7});
    //three ball stack #1
    ...
    //matchload.matchloadV(0);
    //three ball stack #2
    chassis.moveToPoint(-22.5, 48.4, 1800, {.minSpeed = 45, .earlyExitRange = 2, .pidSelector = 1});
    chassis.waitUntil(25.75);
    matchload.matchloadV(1);
    chassis.turnToPoint(-46.75, 31, 1100, {.minSpeed = 10, .earlyExitRange = 2, .shortTurn = true});
    chassis.moveToPoint(-46.75, 31, 2000, {.minSpeed = 40, .earlyExitRange = 2, .clampDistance = false});
    ...
    chassis.resetPositionRight();
    chassis.resetPositionFront();
    chassis.turnToPoint(-47.25, 10, 400, {.minSpeed = 30, .earlyExitRange = 4, .shortTurn = true});
    pros::delay(400);
    intake.intakePneumaticV(0);
    //matchload #2
    ...
    chassis.turnToPoint(-12.5, 61, 800, {.forwards = false, .minSpeed = 10, .earlyExitRange = 2, .shortTurn = true});
    //middle goal
    chassis.moveToPoint(-12.5, 61, 1500, {.forwards = false, .minSpeed = 45, .earlyExitRange = 1, .clampDistance = false});
...
void skills() {
  /*  chassis.setPose(0, -60, 180);
    ...
    //pros::delay(800);
    //intake.moveBottomIntake(0);
    chassis.turnToPoint(12, -12.5, 2000, {.minSpeed = 10, .earlyExitRange = 1, .pidSelector = 2});
    chassis.moveToPoint(12, -12.5, 4000, {.minSpeed = 15});
    ...
    pros::delay(250);
    intake.moveTopIntake(-250);
    intake.moveMiddleIntake(-250);
    pros::delay(2700);
    chassis.setDrive(1600, 1600);
    pros::delay(600);
    chassis.setDrive(0,0);
    chassis.moveToPoint(24, -24, 1500, {.forwards = false, .minSpeed = 20, .earlyExitRange = 2});
    //intakeLift.intakeLiftV(0);
    //three ball stack #2
    chassis.turnToPoint(-22.5, -27, 1500, {.minSpeed = 10, .earlyExitRange = 4, .pidSelector = 2});
    intakeLift.intakeLiftV(0);
    intake.hoard();
    chassis.moveToPoint(-22.5, -27, 1700, {.minSpeed = 50, .earlyExitRange = 4, .clampDistance = false});
    //chassis.waitUntil(25.75);
    //matchload.matchloadV(1);
    ...
    chassis.moveToPoint(-55, 16, 1900, {.forwards = false, .minSpeed = 25, .earlyExitRange = 2, .pidSelector = 1, .clampDistance = false});
    ...
    chassis.swingToHeading(0, DriveSide::LEFT, 2000, {.direction = AngularDirection::CW_CLOCKWISE, .minSpeed = 75, .earlyExitRange = 5});
    //chassis.waitUntil(11);
    chassis.waitUntilDone();
    matchload.matchloadV(1);
    ...
    chassis.moveToPoint(0, 42, 1500, {.minSpeed = 25, .earlyExitRange = 2});
    chassis.turnToPoint(0, 72, 1000, {.minSpeed = 10 , .earlyExitRange = 2});
    intake.hoard();
    chassis.waitUntilDone();
    chassis.setDrive(8000, 8000);
    pros::delay(650);
